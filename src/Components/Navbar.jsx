...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between bg-slate-950 w-full p-1 sm:px-3 md:px-3 py-4">
      <div className="flex items-center gap-3">
        <img src={logo} alt="logo" className="h-[50px] rounded-full w-[50px]" />
        <Link to="/">
          <h3 className="text-white text-lg font-bold md:text-2xl lg:text-4xl">
            Welcome To CryptoGeeko
          </h3>
        </Link>
      </div>
